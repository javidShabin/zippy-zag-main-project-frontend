  ...
  return (
    <>
      ...
      >
        <img
          src={mintImage}
          className="w-[50px] sm:w-[80px] absolute top-10 sm:top-20 right-16 sm:right-56 animate-pulse transition duration-700"
        />
        <img
          src={tomatoImage}
          className="w-[50px] sm:w-[80px] absolute bottom-5 right-20 sm:right-80 animate-pulse transition duration-700"
        />
        <img
          src={mint1Image}
          className="w-[70px] sm:w-[120px] absolute bottom-5 left-20 sm:left-80 animate-pulse transition duration-700"
        />
        <img
          src={tomato1Image}
          className="w-[90px] sm:w-[150px] absolute top-5 sm:top-10 left-14 sm:left-56 animate-pulse transition duration-700"
        />
        <img
          src={chillyImage}
          className="w-[70px] sm:w-[110px] absolute bottom-20 sm:bottom-60 right-0 animate-pulse transition duration-700"
        />
        <img
          src={chilly1Image}
