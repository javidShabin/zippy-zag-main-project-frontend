...
import { bannerImage, heroImage, mintLeav, tomato1Image } from "../assets";
  ...
  return (
    <>
      ...
      >
        ...
        <img src={tomato1Image} className="w-[150px] absolute top-28 left-52 animate-bounce transition duration-300 " />
